import random
import json
from mtp.methods.token import Token
from mtp.methods.instruction import Instruction
from mtp.methods.guardrail import Guardrail
from mtp.methods.util import get_possible_emojis
