"""
Test fixtures and sample data for Model Train Protocol.
...
- tokens.py: Sample token data and token creation helpers

These fixtures provide reusable test data and helper functions to reduce code duplication
and ensure consistent test data across the test suite.
"""
