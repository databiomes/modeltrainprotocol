...
def get_basic_instructions() -> Dict[str, Any]:
    ...
    return {
        'simple_instruction': Instruction(name='instruction_1', 
        ...
        'result_instruction': Instruction(name='instruction_1', 
...
def get_numtoken_instructions() -> Dict[str, Any]:
    ...
    return {
        'simple_numtoken_instruction': Instruction(name='instruction_1', 
        ...
        'result_numtoken_instruction': Instruction(name='instruction_1', 
...
def get_numlisttoken_instructions() -> Dict[str, Any]:
    ...
    return {
        'simple_numlisttoken_instruction': Instruction(name='instruction_1', 
        ...
        'result_numlisttoken_instruction': Instruction(name='instruction_1', 
        ...
        'scores_instruction': Instruction(name='instruction_1', 
...
def get_mixed_numeric_instructions() -> Dict[str, Any]:
    ...
    return {
        'simple_mixed_instruction': Instruction(name='instruction_1', 
        ...
        'result_mixed_instruction': Instruction(name='instruction_1', 
