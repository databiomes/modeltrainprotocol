...
from tests.fixtures.correct_protocols import add_context_to_protocol, create_user_instruction, create_simple_instruction


def create_comprehensive_protocol(name: str = "example_protocol",
